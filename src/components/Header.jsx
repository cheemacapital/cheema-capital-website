...
export default function Header({ onLogoClick, onServicesClick, onWhoWeAreClick, onBookClick }) {
  // /book and /who-we-are are real pages outside the SPA (like
  // /champaign-urbana), so these are plain <a>s, not buttons — but
  // intercept ordinary clicks to run the same fade-out the rest of the app
  // uses (navigateExternal in FunnelApp.jsx) instead of cutting away
  // instantly. Modified clicks (new tab, new window) pass through untouched.
    ...
    <header className="site-header">
      <div className="wrap site-header__inner">
        ...
        <div className="site-header__nav">
          ...
          <a href="/who-we-are/" className="header-link" onClick={handleWhoWeAreClick}>Who we are</a>
